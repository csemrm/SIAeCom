...
//        $upload_path = assets_server_path('products_images/', 'images');
//        $fields['item_image_upload'] = array('type' => 'file', 'accept' => 'gif,jpg,jpeg,png', 'upload_path' => $upload_path, 'overwrite' => TRUE, 'order' => $fields['item_image_upload']['order'], 'before_html' => $fields['item_image_upload']['before_html']);
        $fields['file_example'] = array('type' => 'file', 'overwrite' => TRUE, 'display_overwrite' => false, 'multiple' => true);
