    ...
    function checkout() {
        ...
        if (!empty($_POST)) {
            ...
            if ($this->_process($_POST)) {
                ...
                redirect(redirect('addtocart/order_review'));
            }
        }
        ...
        $fields['state'] = array('required' => TRUE, 'class' => 'small');
        $fields['postalcode'] = array('required' => TRUE, 'label' => 'Zip/Post Code', 'class' => 'small');
//        $fields['country'] = array('required' => TRUE, 'value' => $user['country'], 'class' => 'small', 'type' => 'select',
...
//        );
        ...
        $this->form_builder->css_class = 'search_box';
...
//        if (!empty($_POST)) {
        ...
        $this->_sent_email_process($viewhtml1);
//        }

        $this->load->view('SIATEX/addtocart/submit', $data);
    }

    protected function _sent_email_process($viewhtml1) {
        ($this->printview($viewhtml1));

        $this->load->library('email');


        $this->email->from('sales1@promotexbd.com', 'Your Name');
        $this->email->to('csemrm@gmail.com');
        $this->email->cc('csemrm@yahoo.com');
    ...
    public function printview($viewhtml1 = null) {
